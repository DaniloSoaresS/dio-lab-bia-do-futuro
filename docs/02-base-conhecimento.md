...
Serão carregador via código, como no exemplo abaixo:
...
Nossa abordagem atual consiste em injetar os dados no prompt para otimizar o contexto do Agente de forma simples. Para evoluirmos para uma solução mais robusta e flexível, o próximo passo ideal seria implementar o carregamento dinâmico dessas informações.
